    ...
    <div class="container mt-4 mb-4 p-3 d-flex justify-content-center">
        <div class="card p-4">
            <div class=" image d-flex flex-column justify-content-center align-items-center"> <button class="btn btn-secondary">
                    <div class="chat-image">{!! makeImageFromNameProfile($name) !!}</div></button>
                ...
                <div class=" d-flex mt-2"> <button type="submit" class="btn-dark">Submit</button></div>
                <div class="text mt-3"> <span> <input type="text" name="bio" value={{$bio}}> </span> </div>
